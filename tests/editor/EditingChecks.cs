...
Check(Complete("math.ra|").SequenceEqual(new[] { "rad", "random", "randomseed" }), "random completion");
Check(Complete("math.random|").Contains("randomseed"), "randomseed completion");
Check(Complete("gra|").Contains("graph"), "graph API");
Check(Complete("graph.|").SequenceEqual(new[] { "axes", "clear", "marker", "series" }), "graph members");
Check(Complete("graph.s|").SequenceEqual(new[] { "series" }), "graph series");
Check(Complete("thing.graph.s|", true).Length == 0, "nested graph is not global graph");
